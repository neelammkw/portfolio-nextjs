...
const HireMe = () => {
  return (
    <div className="fixed -top-2 left-4 flex items-center justify-center overflow-hidden  md:right-8 md:left-auto md:hidden md:absolute sm:right-0 sm:bottom-80">
